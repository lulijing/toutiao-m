  ...
  <div class="login-container">
    ...
    <van-form @submit="onSubmit" ref="loginForm">
      ...
      <van-field v-model="user.code" name="code" placeholder="请输入验证码" :rules="userFormRules.code" type="number" maxlength="6">
        ...
        <template #button>
          <van-count-down v-if="isCountDownShow" @finish="isCountDownShow = false" :time="1000 * 10" format="ss s" />
          <van-button v-else class="send-sms-btn" round size="small" type="default" @click="onSendms" native-type="button">发送验证码</van-button>
        </template>
      </van-field>
